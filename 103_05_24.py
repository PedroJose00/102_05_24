...
with XDMFFile(mesh.comm, "./09_05_24/fem_function_BVTV.xdmf", "w") as file:
...
# ----------------------------------------------------------------------------------
with XDMFFile(mesh.comm, "./09_05_24/fem_function_modulo_E_0.xdmf", "w") as file:
          file.write_mesh(mesh)
          file.write_function(fem_function_modulo_E_f ,0.0)


with XDMFFile(mesh.comm, "./09_05_24/fem_function_densidad_0.xdmf", "w") as file:
          file.write_mesh(mesh)
...
sigma_vm_h = Function(W,name="Von_misses (Nmm2)")
...
escalar_tmp_ar2 = 0.004536  # Este valor debe de estar en days/mm[2] Valor para fase R2
...
condicion_trabecular = array_BVTV <= 0.29
# ---------------------------------------------------------------------------------------------------------
# ---------------------------------------------------------------------------------------------------------
# ---------------------------------------------------------------------------------------------------------
...
for dmes in range(1, 2):
    ...
    for dday in range(1, 24):  # Ciclo externo con dtime va de 1 a 24
        ...
        for cycle in range(1000, 10001, 1000):  # Ciclo interno va de 1000 en 1000 hasta 10000
            ...
            expression_array_dot_vr = (1 - array_porosidad) * escalar_V_bmu * array_derivative_NBMU * escalar_tmp_ar1 * (t_prima_24 /escalar_TR)**2 *t_prima_24
            fem_function_vr_dot.x.array[:] = expression_array_dot_vr
          
            array_BVTV[condicion_trabecular] = array_BVTV[condicion_trabecular] + array_derivative_NBMU[condicion_trabecular]*escalar_a_hemi/escalar_TR
            ...
            with XDMFFile(mesh.comm, "./09_05_24/fase_1/fem_function_array_rdot.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_rdot , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_1/fem_function_array_psi.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_psi , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_1/fem_function_array_error.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_error , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_1/fem_function_array_alpha.xdmf", "w") as file:
                file.write_mesh(mesh)
    ...
    with XDMFFile(mesh.comm, "./09_05_24/fase_1/fem_function_densidad_fase_1.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./09_05_24/fase_1/fem_function_BVTV_fase_1.xdmf", "w") as file:
        file.write_mesh(mesh)
...
#---------------------------------------------------------------------------------------------------
    ...
    for dday in range(1, 8):  # Ciclo externo con dtime va de 1 a 8
        ...
        for cycle in range(1000, 10001, 1000):  # Ciclo interno va de 1000 en 1000 hasta 10000
            ...
            expression_array_dot_vr = array_BVTV * escalar_V_bmu * array_derivative_NBMU * escalar_tmp_ar1 * t_prima_8
            fem_function_vr_dot.x.array[:] = expression_array_dot_vr
    
            array_BVTV[condicion_trabecular] = array_BVTV[condicion_trabecular] + array_derivative_NBMU[condicion_trabecular]*escalar_a_hemi*t_prima_8 /escalar_TF
            ...
            # ----------------------------------------------------------------------------------------------------------
            with XDMFFile(mesh.comm, "./09_05_24/fase_2/fem_function_array_modulo.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_modulo_E_f , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_2/fem_function_array_damage.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_damage , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_2/fem_function_array_rdot.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_rdot , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_2/fem_function_array_psi.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_psi , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_2/fem_function_array_error.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_error , tmp_cycle)    
    ...
    with XDMFFile(mesh.comm, "./09_05_24/fase_2/fem_function_densidad.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./09_05_24/fase_2/fem_function_BVTV.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_day)
...
#----------------------------------------------------------------------------------------------
    for dday in range(1, 64):  # Ciclo externo con dtime va de 1 a 64
        ...
        for cycle in range(1000, 10001, 1000):  # Ciclo interno va de 1000 en 1000 hasta 10000
            ...
            array_BVTV[condicion_trabecular] = array_BVTV[condicion_trabecular] + array_derivative_NBMU[condicion_trabecular]*escalar_a_hemi*t_prima_64/escalar_TF
            ...
            # ----------------------------------------------------------------------------------------------------------
            with XDMFFile(mesh.comm, "./09_05_24/fase_3/fem_function_array_modulo.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_modulo_E_f , tmp_cycle)    
            
            with XDMFFile(mesh.comm, "./09_05_24/fase_3/fem_function_array_damage.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_damage , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_2/fem_function_alpha.xdmf", "w") as file:
                 file.write_mesh(mesh)
                 file.write_function(fem_function_alpha , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_3/fem_function_array_rdot.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_rdot , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_3/fem_function_array_psi.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_psi , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_3/fem_function_array_error.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_error , tmp_cycle)    
    ...
    with XDMFFile(mesh.comm, "./09_05_24/fase_3/fem_function_densidad_fase_3.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./09_05_24/fase_3/fem_function_BVTV_fase_3.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_day)
...
#----------------------------------------------------------------------------------------------
    for dday in range(1, 5):  # Ciclo externo con dtime va de 1 a 5
        ...
        for cycle in range(1000, 10001, 1000):  # Ciclo interno va de 1000 en 1000 hasta 10000
            ...
            expression_array_dot_vr = array_BVTV * array_derivative_NBMU * escalar_V_bmu * escalar_tmp_ar2 * t_prima_100
            ...
            escalar_vm = escalar_vm_prim*(t_prima_100 - escalar_t_nm + 4)/escalar_t_prim
            print(f"el valor de escalar_vm:{escalar_vm}")
            
            array_vm[condicion_cortical] = (escalar_vm * expression_array_dot_vb[condicion_cortical] +  escalar_vm * expression_array_dot_vr[condicion_cortical])/(array_BVTV[condicion_cortical] + expression_array_dot_vb[condicion_cortical] + expression_array_dot_vr[condicion_cortical])
            #array_BVTV_previous = expression_array_dot_vb_c + expression_array_dot_vr_c
            escalar_promedio_vm = np.mean(array_vm[condicion_cortical])
            #escalar_promedio_BVTV_previous = np.mean(array_BVTV_previous)
            print(f"Promedio de array_vm: {escalar_promedio_vm}")
            #print(f"Promedio de BVTV_previous: {escalar_promedio_BVTV_previous}")

            #-------------------------------------------------------------------------------------------
            # Hay que determinar el valor del porcentaje de cenizas.
            #-------------------------------------------------------------------------------------------
            array_alpha_t[condicion_cortical] = array_alpha[condicion_cortical] + (escalar_rho_mineral*array_vm[condicion_cortical]/(escalar_rho_mineral*array_vm[condicion_cortical] + escalar_v_org* escalar_rho_org))
            array_alpha[condicion_cortical] = (array_BVTV[condicion_cortical]*array_alpha[condicion_cortical] + expression_array_dot_vb[condicion_cortical] *array_alpha_t[condicion_cortical] 
                                               + expression_array_dot_vr[condicion_cortical]*array_alpha_t[condicion_cortical])/(array_BVTV[condicion_cortical])

            
            escalar_promedio_alpha = np.mean(array_alpha[condicion_cortical])
            print(f"Promedio de array_alpha: {escalar_promedio_alpha}")

            array_BVTV[condicion_trabecular] = array_BVTV[condicion_trabecular] + array_derivative_NBMU[condicion_trabecular]*escalar_a_hemi
            ...
            # ----------------------------------------------------------------------------------------------------------
            with XDMFFile(mesh.comm, "./09_05_24/fase_4/fem_function_modulo.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_modulo_E_f , tmp_cycle)    
            
            with XDMFFile(mesh.comm, "./09_05_24/fase_4/fem_function_BVTV.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_BVTV , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_4/fem_function_array_modulo.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_modulo_E_f , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_4/fem_function_array_vm.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_vm , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_4/fem_function_array_damage.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_damage , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_2/fem_function_alpha.xdmf", "w") as file:
                 file.write_mesh(mesh)
                 file.write_function(fem_function_alpha , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_4/fem_function_array_rdot.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_rdot , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_4/fem_function_array_psi.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_psi , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_4/fem_function_array_error.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_error , tmp_cycle)    
    ...
    with XDMFFile(mesh.comm, "./09_05_24/fase_4/fem_function_densidad_fase_4.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./09_05_24/fase_4/fem_function_BVTV_fase_4.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_day)
...
#            print(f" dentro de la quinta etapa -->> La expression_array_dot_vr: { escalar_tmp_ar5}")
            ...
            array_BVTV[condicion_trabecular] = array_BVTV[condicion_trabecular] + array_derivative_NBMU[condicion_trabecular]
            array_BVTV[condicion_cortical]= array_BVTV[condicion_cortical] + expression_array_dot_vr[condicion_cortical]
            #-------------------------------------------------------------------------------------------------------
            array_BVTV_mean=np.mean(array_BVTV[condicion_cortical])
            array_rho_cortical_gr_cm_3 = array_BVTV[condicion_cortical]*(1.41 +1.29*array_alpha[condicion_cortical]) 
...
#            array_modulo_E_f[condicion_cortical]= 84370 * (array_BVTV[condicion_cortical] ** 2.58) * (array_alpha ** 2.74) *1e3
            ...
            # ----------------------------------------------------------------------------------------------------------
            with XDMFFile(mesh.comm, "./09_05_24/fase_5/fem_function_array_modulo.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_modulo_E_f , tmp_cycle)    
            
            with XDMFFile(mesh.comm, "./09_05_24/fase_5/fem_function_array_damage.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_damage , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_5/fem_function_array_alpha.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_alpha , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_5/fem_function_array_rdot.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_rdot , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_5/fem_function_array_psi.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_psi , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_5/fem_function_array_error.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_error , tmp_cycle)    
    ...
    with XDMFFile(mesh.comm, "./09_05_24/fase_5/fem_function_densidad_fase_5.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./09_05_24/fase_5/fem_function_BVTV_fase_5.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_day)
    print("---------------------------------------------------------")              
    print("El valor promedio de la BVTV es:", promedios_BVTV[escalar_contador_total_dias])
...
#-------------------------------------------------------------------------------------------
    # Para fase #6 Esta fase dura 32 dias + TR + TI
#-------------------------------------------------------------------------------------------
...
#            array_modulo_E_f[condicion_cortical]= 84370 * (array_BVTV[condicion_cortical] ** 2.58) * (array_alpha ** 2.74) *1e3
            ...
            # ----------------------------------------------------------------------------------------------------------
            with XDMFFile(mesh.comm, "./09_05_24/fase_6/fem_function_array_modulo.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_modulo_E_f , tmp_cycle)    
            
            with XDMFFile(mesh.comm, "./09_05_24/fase_6/fem_function_array_damage.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_damage , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_2/fem_function_alpha.xdmf", "w") as file:
                 file.write_mesh(mesh)
                 file.write_function(fem_function_alpha , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_6/fem_function_array_rdot.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_rdot , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_6/fem_function_array_psi.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_psi , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_6/fem_function_array_error.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_error , tmp_cycle)    
...
#            array_modulo_E_f[condicion_cortical]= 84370 * (array_BVTV[condicion_cortical] ** 2.58) * (array_alpha ** 2.74) *1e3
            ...
            # ----------------------------------------------------------------------------------------------------------
            with XDMFFile(mesh.comm, "./09_05_24/fase_7/fem_function_array_modulo.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_modulo_E_f , tmp_cycle)    
            
            with XDMFFile(mesh.comm, "./09_05_24/fase_7/fem_function_array_damage.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_damage , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_2/fem_function_alpha.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_alpha , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_7/fem_function_array_rdot.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_rdot , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_7/fem_function_array_psi.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_psi , tmp_cycle)    
            with XDMFFile(mesh.comm, "./09_05_24/fase_7/fem_function_array_error.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_error , tmp_cycle)    
            ...
            sigma_vm_h.interpolate(sigma_vm_expr)
             ...
             # ----------------------------------------------------------------------------------
            with XDMFFile(mesh.comm, "./09_05_24/misses_.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(sigma_vm_h , dday)
            with XDMFFile(mesh.comm, "./09_05_24/displacements_.xdmf", "w") as file:
                file.write_mesh(mesh)
    ...
    with XDMFFile(mesh.comm, "./09_05_24/fase_7/fem_function_densidad_fase_7.xdmf", "w") as file:
        file.write_mesh(mesh)
...
# with open('./09_05_24/rst_densidad_daño_elasticidad.csv', mode='w', newline='') as file:
...
data.to_csv('./09_05_24/resultados_promedio_final.csv', index=False)
